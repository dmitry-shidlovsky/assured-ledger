...
func BeforeStep(fn smachine.StateFunc) Predicate {
...
func AfterStepExt(s smachine.SlotStep) Predicate {
	return func(event debuglogger.UpdateEvent) bool {
...
func AfterTestString(marker string) Predicate {
	return func(event debuglogger.UpdateEvent) bool {
...
func AfterCustomEvent(fn func(interface{}) bool) Predicate {
	return func(event debuglogger.UpdateEvent) bool {
		return event.Data.EventType.IsEvent() && fn(event.CustomEvent)
	}
}

func AfterCustomEventType(tp reflect.Type) Predicate {
	return func(event debuglogger.UpdateEvent) bool {
